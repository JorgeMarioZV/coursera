...
function displayHREmployees () {
    ...
    const hrEmployeesDisplay = hrEmployees.map((hrEmployee, index) =>
         `<p>${hrEmployee.id} : ${hrEmployee.name} - ${hrEmployee.department} - $${hrEmployee.salary}</p>` // esto se puede escribir simplemente asi porque implicitamente es el valor del return
        //  or with {return ...;}
    ).join('');
